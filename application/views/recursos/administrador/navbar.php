        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
            ...
            <div class="navbar-collapse collapse" id="navbarsExampleDefault" style="">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo site_url('Jefe/platicas'); ?>"><i class="fas fa-fw fa-bars"></i> Ver Pláticas Registradas</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown01">
                            <a class="dropdown-item" href="<?php echo site_url('Supervisor/platicas'); ?>"><i class="fas fa-fw fa-bars"></i> Ver Pláticas Vigentes</a>
                            ...
                            <!-- <a class="dropdown-item" href="https://vdbdelta.pc.cmbjpc.com.mx/Reports_DBDELTA/Pages/Report.aspx?ItemPath=%2fSegurida%2fPERSONAL+POR+PLATICA+Y+PERSONAL" target="_blank"><i class="far fa-fw fa-list-alt""></i> Reporte Historial de Pláticas</a> -->
                            <a class="dropdown-item" href="<?php echo site_url('Supervisor/reporte_platicas'); ?>"><i class="far fa-fw fa-list-alt""></i> Reporte Historial de Pláticas</a>
                        </div>
                    </li>
                    <li class="nav-item">
